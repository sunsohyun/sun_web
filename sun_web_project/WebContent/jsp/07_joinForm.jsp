...
<body>
	...
	<div class="content">
		<section class="join">
			...
			<form name="joinForm" action="07_joinCheck.jsp" method="post"><!-- method post : url에 데이터 안보이게 하기 -->
				<ul>
					<li>
						<label>아이디</label>
						<input type="text" name="id" placeholder="*8자 이상입력해주세요." class="input1" id="id">
						<button type="button" class="btn_style2">중복확인</button>
					</li>
					<li>
						<label>비밀번호</label>
						<input type="password" name="password" class="input1" id="pass">
					</li>
					<li>
						<label>비밀번호 확인</label>
					...
					<li>
						...
						- <input type="text" name="phone2" id="phone2"><!-- name다르게 준 이유는 서버에 넘어가는 값이 다르게 때문 -->
